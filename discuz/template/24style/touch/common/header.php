...
<link rel="stylesheet" href="{$_G['style']['mistaticdir']}/wubian/style.css" type="text/css" media="all">
<script src="{$_G['style']['mistaticdir']}/wubian/jquery.min.js?{VERHASH}"></script>
...
<link rel="stylesheet" type="text/css" href="{$_G['style']['mistaticdir']}/wubian/font/iconfont.css">
</head>
<body class="bg">
