...
<link rel="stylesheet" href="{$_G['style']['styleimgdir']}/wubian/style.css" type="text/css" media="all">
<script src="{$_G['style']['styleimgdir']}/wubian/jquery.min.js?{VERHASH}"></script>
...
<link rel="stylesheet" type="text/css" href="{$_G['style']['styleimgdir']}/wubian/font/iconfont.css">
</head>
<body class="bg">
