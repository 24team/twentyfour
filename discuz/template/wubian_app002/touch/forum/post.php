...
<header class="header">
    <div class="nav">
		...
		<a href="<!--{if $_GET[action] == 'newthread'}-->forum.php?mod=forumdisplay&fid=$_G[fid]&page=$_GET[page]<!--{else}-->forum.php?mod=redirect&goto=findpost&ptid=$_G[tid]&pid=$pid<!--{/if}-->" class="z wubianfont iconback fznav grey"></a>
...
<div class="wp">
	<div class="post_from">
		<ul class="cl">
			<li>
			<!--{if $_GET['action'] != 'reply'}-->
			<input type="text" tabindex="1" class="post_input" id="needsubject" size="30" autocomplete="off" value="$postinfo[subject]" name="subject" placeholder="{lang thread_subject}" fwin="login">
			<!--{else}-->
				RE: $thread['subject']
			...
			<li style="padding:0;">
				<a href="javascript:;" class="y photo"><input type="file" name="Filedata" id="filedata" /></a>
			</li>
		</ul>
...
<!-- header end -->
<div class="box xg1 hm grey mtw mbw">
	<!--{if $special == '2'}-->
