...
class magic_repent {
	...
	function usesubmit() {
		...
		showmessage(lang('magic/repent', 'repent_succeed'), $post['first'] ? 'forum.htm?mod=forumdisplay&fid='.$post['fid'] : dreferer(), array(), array('alert' => 'right', 'showdialog' => 1, 'locationtime' => true));
	}
