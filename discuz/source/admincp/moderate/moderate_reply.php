...
if(!submitcheck('modsubmit') && !$_GET['fast']) {
	...
	foreach($postarr as &$post) {
		...
		showtablerow("id=\"mod_$post[pid]_row1\"", array("id=\"mod_$post[pid]_row1_op\" rowspan=\"3\" class=\"rowform threadopt\" style=\"width:80px;\"", '', 'width="120"', 'width="120"', 'width="55"'), array(
			...
			"<a href=\"forum.htm?mod=forumdisplay&fid=$post[fid]\">$post[forumname]</a>",
			...
			"<a target=\"_blank\" href=\"forum.htm?mod=redirect&goto=findpost&ptid=$post[tid]&pid=$post[pid]\">$lang[view]</a>&nbsp;<a href=\"forum.htm?mod=viewthread&tid=$post[tid]&modthreadkey=$post[modthreadkey]\" target=\"_blank\">$lang[edit]</a>",
		));
