...
if(!submitcheck('modsubmit') && !$_GET['fast']) {
	...
	foreach($threadlist as $thread) {
		...
		showtablerow("id=\"mod_$thread[tid]_row1\"", array("id=\"mod_$thread[tid]_row1_op\" rowspan=\"3\" class=\"rowform threadopt\" style=\"width:80px;\"", '', 'width="120"', 'width="120"', 'width="55"'), array(
			...
			"<a target=\"_blank\" href=\"forum.htm?mod=forumdisplay&fid=$thread[fid]\">$forumname</a>",
			"<p>$thread[author]</p> <p>$thread[dateline]</p>",
			"<a target=\"_blank\" href=\"forum.htm?mod=viewthread&tid=$thread[tid]&modthreadkey=$thread[modthreadkey]\">$lang[view]</a>&nbsp;<a href=\"forum.htm?mod=post&action=edit&fid=$thread[fid]&tid=$thread[tid]&pid=$thread[pid]&modthreadkey=$thread[modthreadkey]\" target=\"_blank\">$lang[edit]</a>",
		));
