			...
			if($postlist) {
				foreach($postlist as $post) {
					$posts .= showtablerow('', '', array(
						...
						"<a href=\"forum.htm?mod=redirect&goto=findpost&pid=$post[pid]&ptid=$post[tid]\" target=\"_blank\">$post[subject]</a>",
						$post['message'],
					"<a href=\"forum.htm?mod=forumdisplay&fid=$post[fid]\" target=\"_blank\">".$forumnames[$post[fid]]."</a>",
