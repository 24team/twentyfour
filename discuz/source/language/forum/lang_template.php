...
$lang = array (
  ...
  'collection_nocollection' => '还没有淘专辑，快来<a href="forum.htm?mod=collection&action=edit">创建</a>吧',
  ...
  'collection_cloud_search' => '淘专辑还没有内容，您可以点击 <a href="forum.htm?mod=collection&action=view&ctid={$ctid}&op=related" class="xi2">搜索相关主题</a> 找到相关内容。',
  ...
  'post_hide_reply_hidden' => '，如果您要查看本帖隐藏内容请<a href="forum.htm?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'ban_member' => '禁止',
  'clear' => '清理',
  'collection_fromctid' => '您是从淘专辑 <a href="forum.htm?mod=collection&action=view&ctid=$post[sourcecollection][ctid]" target="_blank" class="xi2">$post[sourcecollection][name]</a> 访问到本帖的，欢迎对专辑打分：',
  'collection_rate' => '评分',
