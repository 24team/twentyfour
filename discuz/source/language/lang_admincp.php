...
(
	...
	'setting_basic_index_name_comment' => '设置站点首页的文件名，默认为“forum.htm?mod=index”，如果您更改了此设置，那么您需要使用“FTP工具”手动重命名文件名称',
...
',
	...
	'setting_credits_policy_promotion_visit_comment' => '访问者通过用户提供的推广链接(如 forum.htm?mod=index&fromuid=1、?fromuser=username)访问站点，推广人所得的积分数',
	'setting_credits_policy_promotion_register' => '注册推广(+)',
	'setting_credits_policy_promotion_register_comment' => '访问者通过用户提供的推广链接(如 forum.htm?mod=register&fromuid=2、?fromuser=username)访问站点并注册新会员，推广人所得的积分数',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'tasks_add_limit_threadid_comment' => '设置会员只有回复该主题才能完成任务，请填写主题的 tid(比如一个主题的地址是 http://localhost/forum.htm?mod=viewthread&tid=8 那么该主题的 tid 就是 8)',
