...
$lang = array (
  ...
  'my_thread' => '我的话题',
  'no_group_create_now' => '您还没创建{$_G[setting][navs][3][navname]}，<a href="forum.htm?mod=group&action=create">现在创建</a>',
  ...
  'group_category_no_groups_detail' => '返回上级分类重新选择，或者[<b><a href="forum.htm?mod=group&action=create&fupid={$curtype[fup]}&groupid=$sgid">创建一个新的{$_G[setting][navs][3][navname]}</a></b>]',
