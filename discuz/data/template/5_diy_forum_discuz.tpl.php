...
0
|| checktplrefresh('./template/24style/forum/discuz.htm', './template/24style/forum/discuz_threads.htm', 1582471372, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/24style', 'forum/discuz')
|| checktplrefresh('./template/24style/forum/discuz.htm', './template/24style/common/sidefoot.htm', 1582471372, 'diy', './data/template/5_diy_forum_discuz.tpl.php', './template/24style', 'forum/discuz')
...
<li style="width:52px;">
  <span class="txt" style="color:#C60D16;"><?php echo $onlinenum;?></span>
  <span class="txt">人在线</span>
</li>
<li style="width:52px;">
  <span class="txt" style="color:#C60D16;"><?php echo $membercount;?></span>
  <span class="txt">会员</span>
</li>
<li style="width:52px;">
  <span class="txt" style="color:#C60D16;"><?php echo $invisiblecount;?></span>
  <span class="txt">隐身</span>
</li>
<li style="width:52px;">
  <span class="txt" style="color:#C60D16;"><?php echo $guestcount;?></span>
