...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1584027647, '7', './data/template/7_7_common_header_misc_mobile.tpl.php', './template/24style', 'common/header_misc_mobile')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1584027647, '7', './data/template/7_7_common_header_misc_mobile.tpl.php', './template/24style', 'common/header_misc_mobile')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1584027647, '7', './data/template/7_7_common_header_misc_mobile.tpl.php', './template/24style', 'common/header_misc_mobile')
;?>
