...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1585710341, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1585710341, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1585710341, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
;?>
