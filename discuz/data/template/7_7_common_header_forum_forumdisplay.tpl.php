...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1583983296, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1583983296, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1583983296, '7', './data/template/7_7_common_header_forum_forumdisplay.tpl.php', './template/24style', 'common/header_forum_forumdisplay')
;?>
...
<div id="hd" class="miheader">
  ...
  <td style="padding:0;width:155px;">
    <!-- logo -->
    <a href="<?php echo $_G['siteurl'];?>" class="logo"></a>
  </td>

  <td style="padding:0;">
    <!-- menu --><?php $mnid = getcurrentnav();?><ul id="header_navmenu" style="height:22px;overflow-y:hidden;">
