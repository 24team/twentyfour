...
<p class="xs0">&copy; 2001-2020 <a href="http://24plus.me" target="_blank">24plus.me</a></p>
...
<div id="flk" class="y">
          <p>
            <a href='http://mob.com/#/about' target='_blank'>公司介绍</a>
            <span class="pipe">|</span>
            <a href='http://mob.com/#/policy' target='_blank'>隐私政策</a>
            <span class="pipe">|</span>
            <a href='http://mob.com/#/service' target='_blank'>服务条款</a>
            <span class="pipe">|</span>
            <a href='http://mob.com/#/contact' target='_blank'>联系我们</a>
          </p>
</div>
<div id="frt">
        Copyright &copy; 2012-2016 mob All Rights Reserved
</div>	
</div>
-->
...
<?php } ?>
<span hidefocus="true"><a title="返回顶部" onclick="window.scrollTo('0','0')" class="scrolltopa" ><i class="icon icon-insert"></i></a></span>
<?php if($_G['fid']) { ?>
<span>
<?php if($_G['mod'] == 'viewthread') { ?>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" hidefocus="true" class="returnlist" title="返回列表"><b>返回列表</b></a>
<?php } else { ?>
<a href="forum.php" hidefocus="true" class="returnboard" title="返回版块"><i class="icon icon-home"></i></a>
<?php } ?>
</span>
<?php } ?>
</div>
...
<?php } output();?><style>
.ct2_a {padding-left:230px !important;}
.ct2_a .appl {margin-left:-230px !important;}
.ct2_a .mn {width:100% !important;}
.ct2_a_r {padding-left:0 !important;}
</style>
</body>
</html>
