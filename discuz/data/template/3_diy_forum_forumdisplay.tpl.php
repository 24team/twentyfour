...
0
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/mistyle/forum/forumdisplay_list.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/mistyle/common/sidefoot.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
|| checktplrefresh('./template/mistyle/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1582442372, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', './template/mistyle', 'forum/forumdisplay')
