...
0
|| checktplrefresh('./template/mistyle/common/header.htm', './template/default/common/header_common.htm', 1582442483, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/mistyle', 'common/header_forum_index')
|| checktplrefresh('./template/mistyle/common/header.htm', './template/default/common/header_qmenu.htm', 1582442483, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/mistyle', 'common/header_forum_index')
|| checktplrefresh('./template/mistyle/common/header.htm', './template/mistyle/common/header_userstatus.htm', 1582442483, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/mistyle', 'common/header_forum_index')
;?>
