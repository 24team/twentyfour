<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_card');?>
<?php if($_GET['vs']) { ?>
  <?php include template('common/header'); ?><div class="bm authorcard">
      <a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>" class="avatar" target="_blank"><?php echo avatar($space[uid],middle);?></a>
  <p class="authorname"><?php echo $space['username'];?></p> 
      <span class="authortitle"><?php echo $space['group']['grouptitle'];?></span>
  <ol class="clearfix">
        <li>
      <span class="txt"><?php echo $space['threads'];?></span>
  <span class="txt">主题</span>
</li>
    <li class="integral">
      <span class="txt"><?php echo $space['posts'];?></span>
      <span class="txt">帖子</span>
</li>
<li>
  <span class="txt"><?php echo $space['credits'];?></span>
  <span class="txt">积分</span>
</li>
  </ol>
      <div>
    <a class="mwt-btn mwt-btn-primary mwt-btn-xs" style="width:70px;"
           href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>" target="_blank" rel="noopener noreferrer">Ta的主页</a>
&nbsp;&nbsp;
<a class="mwt-btn mwt-btn-info mwt-btn-xs" style="width:70px;"
           href="home.php?mod=space&amp;do=thread&amp;uid=<?php echo $space['uid'];?>&amp;from=space" target="_blank" rel="noopener noreferrer">Ta的帖子</a>
  </div>
    </div>
  <?php include template('common/footer'); ?>  <?php return;?><?php } include template('common/header'); ?><div class="card_gender_<?php echo $space['gender'];?>"><?php $encodeusername = rawurlencode($space['username']);?><?php if(!empty($_G['setting']['pluginhooks']['space_card_top'])) echo $_G['setting']['pluginhooks']['space_card_top'];?>
<div class="card_mn">
<div class="avt">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>" target="_blank" title="进入<?php echo $space['username'];?>的空间"><?php echo avatar($space[uid],middle);?></a>
</div>
<div class="c">
<p class="pbn cl">
