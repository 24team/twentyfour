...
0
|| checktplrefresh('./template/mistyle/touch/forum/viewthread.htm', './template/mistyle/touch/forum/forumdisplay_fastpost.htm', 1582442016, 'diy', './data/template/3_diy_touch_forum_viewthread.tpl.php', './template/mistyle', 'touch/forum/viewthread')
|| checktplrefresh('./template/mistyle/touch/forum/viewthread.htm', './template/mistyle/touch/common/seccheck.htm', 1582442016, 'diy', './data/template/3_diy_touch_forum_viewthread.tpl.php', './template/mistyle', 'touch/forum/viewthread')
;?>
...
<a href="<?php if($_GET['fromguid'] == 'hot') { ?>forum.php?mod=guide&view=hot&page=<?php echo $_GET['page'];?><?php } else { ?>forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&<?php echo rawurldecode($_GET[extra]);?><?php } ?>" class="z wubianfont iconback fznav grey"></a>
...
<div class="plc cl" id="pid<?php echo $post['pid'];?>">
   <span class="avatar"><img src="<?php if(!$post['authorid'] || $post['anonymous']) { ?><?php echo avatar(0, middle, true);?><?php } else { ?><?php echo avatar($post[authorid], middle, true);?><?php } ?>" style="width:32px;height:32px;" /></span>
...
推荐
<?php } else { if(!empty($postno[$post['number']])) { ?>&nbsp;&nbsp;<?php echo $postno[$post['number']];?><?php } else { ?>&nbsp;&nbsp;<?php echo $post['number'];?><?php echo $postnostick;?><?php } } ?>
</em>
<?php if($post['authorid'] && $post['username'] && !$post['anonymous']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=profile" class="blue"><?php echo $post['author'];?></a>
<?php } else { if(!$post['authorid']) { ?>
<a href="javascript:;" class="blue">游客 <em class="grey"><?php echo $post['useip'];?><?php if($post['port']) { ?>:<?php echo $post['port'];?><?php } ?></em></a>
...
<em><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $_G['forum_thread']['authorid'];?>" rel="nofollow" class="blue" style="margin-right: 10px;">只看楼主</a></em>
<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>
<em><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow" class="blue" style="margin-right: 10px;">看全部</a></em>
<?php } } ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_postbottom_mobile'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_postbottom_mobile'][$postcount];?><?php $postcount++;?><?php } ?><div id="post_new"></div>
<div class="plc cl">
...
<span class="avatar"><img style="height:32px;width:32px;" src="<?php echo avatar($_G[uid], middle, true);?>" /></span>  
<div class="pi">
<ul class="fastpost">
...
[Zheng Ban URL]
https://addon.dismall.com/?@wubian
--><?php } ?><input type="button" value="回复" class="button2" name="replysubmit" id="fastpostsubmit">
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $_G['forum_firstpid'];?>&amp;page=<?php echo $page;?>" class="y photo">
<span class="none">回复</span>
</a>
...
<?php } else { if(!$_G['uid'] || $_G['uid'] && !$allowpostreply) { ?>
