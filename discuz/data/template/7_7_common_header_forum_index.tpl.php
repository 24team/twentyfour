...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1585728433, '7', './data/template/7_7_common_header_forum_index.tpl.php', './template/24style', 'common/header_forum_index')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1585728433, '7', './data/template/7_7_common_header_forum_index.tpl.php', './template/24style', 'common/header_forum_index')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1585728433, '7', './data/template/7_7_common_header_forum_index.tpl.php', './template/24style', 'common/header_forum_index')
;?>
