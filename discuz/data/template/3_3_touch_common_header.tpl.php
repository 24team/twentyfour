...
<link rel="stylesheet" href="<?php echo $_G['style'];?>/touch/wubian/style.css" type="text/css" media="all">
<script src="<?php echo $_G['style']['styleimgdir'];?>/wubian/jquery.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo $_G['style']['styleimgdir'];?>/wubian/font/iconfont.css">
</head>
<body class="bg">
