...
0
|| checktplrefresh('./template/mistyle/forum/guide.htm', './template/default/forum/guide_list_row.htm', 1582465914, '3', './data/template/3_3_forum_guide.tpl.php', './template/mistyle', 'forum/guide')
;?>
<?php if($_GET['inajax']) { ?>
