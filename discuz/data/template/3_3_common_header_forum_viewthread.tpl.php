...
0
|| checktplrefresh('./template/mistyle/common/header.htm', './template/default/common/header_common.htm', 1582441627, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/mistyle', 'common/header_forum_viewthread')
|| checktplrefresh('./template/mistyle/common/header.htm', './template/default/common/header_qmenu.htm', 1582441627, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/mistyle', 'common/header_forum_viewthread')
|| checktplrefresh('./template/mistyle/common/header.htm', './template/mistyle/common/header_userstatus.htm', 1582441627, '3', './data/template/3_3_common_header_forum_viewthread.tpl.php', './template/mistyle', 'common/header_forum_viewthread')
;?>
