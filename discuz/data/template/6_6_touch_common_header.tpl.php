...
<title><?php if($_GET['forumlist'] == '1' || $_GET['mod'] == 'guide') { ?><?php echo $_G['setting']['bbname'];?><?php } else { if(!empty($navtitle)) { ?><?php echo $navtitle;?><?php } if(empty($nobbname)) { ?> - <?php echo $_G['setting']['bbname'];?><?php } } ?></title>
<link rel="stylesheet" href="<?php echo $_G['style']['mistaticdir'];?>/touch/wubian/style.css" type="text/css" media="all">
<script src="<?php echo $_G['style']['mistaticdir'];?>/wubian/jquery.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo $_G['style']['mistaticdir'];?>/wubian/font/iconfont.css">
</head>
<body class="bg">
