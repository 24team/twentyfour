...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1583980020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/24style', 'common/header_forum_viewthread')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1583980020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/24style', 'common/header_forum_viewthread')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1583980020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/24style', 'common/header_forum_viewthread')
;?>
