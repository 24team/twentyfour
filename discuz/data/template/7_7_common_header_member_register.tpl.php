...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1583980655, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/24style', 'common/header_member_register')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1583980655, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/24style', 'common/header_member_register')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1583980655, '7', './data/template/7_7_common_header_member_register.tpl.php', './template/24style', 'common/header_member_register')
;?>
