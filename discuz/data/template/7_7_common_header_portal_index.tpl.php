...
0
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_common.htm', 1583987590, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/24style', 'common/header_portal_index')
|| checktplrefresh('./template/24style/common/header.htm', './template/default/common/header_qmenu.htm', 1583987590, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/24style', 'common/header_portal_index')
|| checktplrefresh('./template/24style/common/header.htm', './template/24style/common/header_userstatus.htm', 1583987590, '7', './data/template/7_7_common_header_portal_index.tpl.php', './template/24style', 'common/header_portal_index')
;?>
